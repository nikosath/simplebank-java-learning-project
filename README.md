...
**Optional stretch goal - Testing Challenge (The Pragmatic Way)**: If you want to push your engineering skills further, read and apply concepts from [test-sociably, fake-the-boundaries](learning-material/test-sociably-fake-the-boundaries.md). Specifically, try to:
